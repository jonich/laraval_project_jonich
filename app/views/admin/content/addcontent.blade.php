		...
		<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('/')}}/administrator/addcontent/<?=$id;?>">
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div style="width:800px;" class="controls">
								<textarea style='height:300px;' name='content' id='richtextarea1'></textarea>		
								<?php $editor=1; ?>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div style="width:800px;" class="controls">
								<textarea style='height:300px;' name='content2' id='richtextarea2'></textarea>		
								<?php $editor=2; ?>
								@include('site.includes.tiny')
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div style="width:800px;" class="controls">
								<textarea style='height:300px;' name='content3' id='richtextarea3'></textarea>		
								<?php $editor=3; ?>
								@include('site.includes.tiny')
							  </div>
							</div>
