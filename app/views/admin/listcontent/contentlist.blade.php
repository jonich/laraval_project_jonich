			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Κατηγορίες Λίστας Περιεχομένου</h2>
						...
						<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center"><?=$contentlist[$i]->place;?></td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="{{URL::to('/')}}/administrator/editlistcontent/<?=$contentlist[$i]->id;?>">
					...
					<button onclick="window.location='{{URL::to('/')}}/administrator/addlistcontent/<?=$listid;?>'" class="btn btn-large btn-success">Προσθήκη</button>
					
				</div><!--/span-->
			
			</div><!--/row-->
			
			<form id="delidform" method="post" action="{{URL::to('/')}}/administrator/deletecontentlist/<?=$listid;?>" >
