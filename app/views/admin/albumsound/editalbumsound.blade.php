		...
		<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Επεξεργασία Albums -  Sound</h2>
						
					</div>
					<div class="box-content">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('/')}}/administrator/editalbumsound/<?=$contentlist->id;?>">
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" name="content" rows="3"><?=$contentlist->bigtext;?></textarea>
							  </div>
							</div>
							...
							<div class="form-actions">
							 ...
							 <button onclick="window.location='{{URL::to('/')}}/administrator/albumsound/<?=$listid;?>'" type="reset" class="btn">Cancel</button>
							</div>
						  </fieldset>
						</form>   
