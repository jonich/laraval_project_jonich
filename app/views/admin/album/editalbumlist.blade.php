		...
		<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('/')}}/administrator/editalbumlist/<?=$contentlist->id;?>">
						  <fieldset>
							...
							<div class="form-actions">
							 ...
							 <button onclick="window.location='{{URL::to('/')}}/administrator/albumcontent/<?=$listid;?>'" type="reset" class="btn">Cancel</button>
							</div>
						  </fieldset>
						</form>   
