		...
		$('#delidform').submit();
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-success" href="{{URL::to('/')}}/administrator/insidealbumlist/<?=$contentlist[$i]->id;?>/<?=$listid;?>" >
										<i class="halflings-icon white zoom-in"></i>  
									</a>
								
									<a class="btn btn-info" href="{{URL::to('/')}}/administrator/editalbumlist/<?=$contentlist[$i]->id;?>">
					...
					<button onclick="window.location='{{URL::to('/')}}/administrator/addalbumlist/<?=$listid;?>'" class="btn btn-large btn-success">Προσθήκη</button>
					
				</div><!--/span-->
			
			</div><!--/row-->
			
			<form id="delidform" method="post" action="{{URL::to('/')}}/administrator/deletealbumlist/<?=$listid;?>" >
