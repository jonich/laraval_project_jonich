		...
		<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Επεξεργασία Video Gallery</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('/')}}/administrator/editvideogeneral/<?=$contentlist->id;?>">
						  <fieldset>
							...
							<div>
								...
								<img style="max-width:200px;" src="{{asset('videos/'.$contentlist->id.'.jpg')}}" />
							</div>
							...
							<div class="form-actions">
							 ...
							 <button onclick="window.location='{{URL::to('/')}}/administrator/videogeneral'" type="reset" class="btn">Cancel</button>
							</div>
						  </fieldset>
						</form>   
