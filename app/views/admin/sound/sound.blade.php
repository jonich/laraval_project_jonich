			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Sounds Gallery</h2>
					</div>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="{{URL::to('/')}}/administrator/editsound/<?=$contentlist[$i]->id;?>">
					...
					<button onclick="window.location='{{URL::to('/')}}/administrator/addsound/<?=$listid;?>'" class="btn btn-large btn-success">Προσθήκη</button>
					
				</div><!--/span-->
			
			</div><!--/row-->
			
			<form id="delidform" method="post" action="{{URL::to('/')}}/administrator/deletesound/<?=$listid;?>" >
